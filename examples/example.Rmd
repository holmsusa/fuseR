...
```{r}
k0 <- read.table('../../methylation/manuscript/simulated_dataset/data/k0_0.75.tsv', header = T, row.names = 1)
k1 <- read.table('../../methylation/manuscript/simulated_dataset/data/k1_0.75.tsv', header = T, row.names = 1)
